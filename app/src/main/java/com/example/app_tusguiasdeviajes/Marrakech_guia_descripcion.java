...
public class Marrakech_guia_descripcion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marrakech_guia_descripcion);

        mAunth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        cancelar = findViewById(R.id.btn_Cancelar_guia_marrakech);
        descargar = findViewById(R.id.descargar_guia_marrakech);
        descripcion = findViewById(R.id.descrpcionGuia);
        destino = findViewById(R.id.destino);
        precio = findViewById(R.id.precio);

        DocumentReference docRef = fStore.collection("guias").document("z2ZEDxmb1g813DZYpHh0");
