...
public class Lisboa_guia_descripcion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lisboa_guia_descripcion);

        mAunth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        cancelar = findViewById(R.id.btn_Cancelar_guia_lisboa);
        descargar = findViewById(R.id.descargar_guia_lisboa);
        descripcion = findViewById(R.id.descrpcionGuia);
        destino = findViewById(R.id.destino);
        precio = findViewById(R.id.precio);

        DocumentReference docRef = fStore.collection("guias").document("vtWDdesyFcoFXBwAiWly");
