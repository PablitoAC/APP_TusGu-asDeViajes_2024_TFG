...
public class Paris_guia_descripcion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paris_guia_descripcion);

        mAunth = FirebaseAuth.getInstance();
        fStore = FirebaseFirestore.getInstance();
        cancelar = findViewById(R.id.btn_Cancelar_guia_paris);
        descargar = findViewById(R.id.descargar_guia_paris);
        descripcion = findViewById(R.id.descrpcionGuia);
        destino = findViewById(R.id.destino);
        precio = findViewById(R.id.precio);

        DocumentReference docRef = fStore.collection("guias").document("w6RyfrHwpqujJfywV60N");
